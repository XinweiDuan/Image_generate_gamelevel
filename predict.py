...
from demo import detect_anmial
...
def parse_args():
    ...
    parser.add_argument(
        "--config", dest="cfg", help="The config file.", default='./configs/deeplabv3p/deeplabv3p_resnet50_os8_cityscapes_1024x512_80k.yml', type=str)
    parser.add_argument(
        '--model_path',
        dest='model_path',
        help='The path of model for prediction',
        type=str,
        default='./models/deeplabv3.pdparams')
    parser.add_argument(
        '--image_path',
        dest='image_path',
